...
mod tests {
    ...
    fn php_runtime_profile_restricts_non_core_endpoints() {
        ...
        assert!(settings.should_route("/wp-content/themes/twentytwelve/inc/custom-header.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/inc/block-patterns.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/search.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/category.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/functions.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/header.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/404.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/page.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/content-page.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/image.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/footer.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/author.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/content-image.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/content-quote.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/sidebar.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwelve/content-link.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentytwo/index.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-image-background.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/header-default.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-logo-navigation-social-black-background.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/general-subscribe.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-query-images-title-citation.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/query-default.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/query-simple-blog.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/footer-logo.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-list-events.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/footer-default.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/query-text-grid.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-sidebar-blog-posts-right.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/footer-dark.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-two-images-text.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/page-about-links.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/query-image-grid.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/footer-navigation.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-about-links-dark.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/header-stacked.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-social-copyright.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/header-large-dark.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-about-title-logo.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentytwo/inc/patterns/footer-blog.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentytwo/inc/block-patterns.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentytwo/functions.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfour/patterns/banner-project-description.php"
        ));
        assert!(settings
        ...
        assert!(settings.should_route("/wp-content/themes/twentytwentyfive/patterns/comments.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/template-query-loop.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-landing-podcast.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/contact-centered-social-link.php"
        ));
        assert!(settings
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-landing-event.php"));
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/pricing-3-col.php")
        );
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/more-posts.php")
        );
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-search-photo-blog.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-shop-home.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/heading-and-paragraph-with-image.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/cta-heading-search.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/footer-columns.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-photo-blog.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/vertical-header.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-portfolio-home.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/hidden-blog-heading.php"));
        assert!(settings
        ...
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/banner-intro.php")
        );
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/format-link.php")
        );
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/hidden-search.php")
        );
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/overlapped-images.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentyfive/patterns/header.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-text-blog.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-coming-soon.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-with-sidebar-news-blog.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/page-landing-book.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentyfive/patterns/footer.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/post-navigation.php"));
        assert!(settings.should_route("/wp-content/themes/twentytwentyfive/patterns/logos.php"));
        assert!(
            settings.should_route("/wp-content/themes/twentytwentyfive/patterns/hidden-404.php")
        );
        assert!(settings
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/footer-centered.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/header-large-title.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-text-blog.php"
        ));
        assert!(settings.should_route(
        ...
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/binding-format.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/cta-book-locations.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/cta-newsletter.php"));
        assert!(
        ...
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-audio.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentythree/patterns/hidden-comments.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentythree/patterns/footer-default.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentythree/patterns/hidden-no-results.php"));
        assert!(
            settings.should_route("/wp-content/themes/twentytwentythree/patterns/post-meta.php")
        );
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/search.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentythree/patterns/hidden-heading.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/category.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentythree/patterns/call-to-action.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/sidebar-content.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentyfourteen/page-templates/contributors.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentyfourteen/page-templates/full-width.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/comments.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content.php"));
        assert!(
            settings.should_route("/wp-content/themes/twentytwentythree/patterns/hidden-404.php")
        );
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/tag.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/featured-content.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/sidebar-footer.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/single.php"));
        assert!(
            settings.should_route("/wp-content/themes/twentyfourteen/content-featured-post.php")
        );
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/functions.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/header.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/taxonomy-post_format.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-video.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/404.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/page.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-gallery.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-page.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/image.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/footer.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/author.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-image.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-quote.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/sidebar.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/content-link.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/back-compat.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/widgets.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/custom-header.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/featured-content.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/customizer.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/template-tags.php"));
        assert!(settings.should_route("/wp-content/themes/twentyfourteen/inc/block-patterns.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/footer-newsletter.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/testimonials-2-col.php"));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/media-instagram-grid.php"));
        assert!(settings.should_route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-text-blog.php"
        ));
        assert!(settings
            .should_route("/wp-content/themes/twentytwentyfive/patterns/hidden-sidebar.php"));
        ...
        assert!(settings.should_route("/wp-admin/network/"));
