...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route(
            ...
            any(wp_content_themes_twentyseventeen_template_parts_post_content_gallery_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/post/content-image.php",
            any(wp_content_themes_twentyseventeen_template_parts_post_content_image_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/page/content-front-page-panels.php",
            any(wp_content_themes_twentyseventeen_template_parts_page_content_front_page_panels_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/page/content-front-page.php",
            any(wp_content_themes_twentyseventeen_template_parts_page_content_front_page_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/page/content-page.php",
            any(wp_content_themes_twentyseventeen_template_parts_page_content_page_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyeleven_inc_block_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyeleven/inc/widgets.php",
            any(wp_content_themes_twentyeleven_inc_widgets_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyeleven/inc/theme-options.php",
            any(wp_content_themes_twentyeleven_inc_theme_options_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyeleven/search.php",
            any(wp_content_themes_twentyeleven_search_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyone_template_parts_header_entry_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/header/site-nav.php",
            any(wp_content_themes_twentytwentyone_template_parts_header_site_nav_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/header/site-header.php",
            any(wp_content_themes_twentytwentyone_template_parts_header_site_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/header/excerpt-header.php",
            any(wp_content_themes_twentytwentyone_template_parts_header_excerpt_header_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyone_template_parts_footer_footer_widgets_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/excerpt/excerpt-audio.php",
            any(wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_audio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/excerpt/excerpt-status.php",
            any(wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_status_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/excerpt/excerpt-link.php",
            any(wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_link_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_chat_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/template-parts/excerpt/excerpt-quote.php",
            any(wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_quote_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/index.php",
            any(wp_content_themes_twentytwentyone_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/archive.php",
            any(wp_content_themes_twentytwentyone_archive_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_customize_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/classes/class-twenty-twenty-one-custom-colors.php",
            any(wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_custom_colors_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/classes/class-twenty-twenty-one-dark-mode.php",
            any(wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_dark_mode_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/classes/class-twenty-twenty-one-customize-notice-control.php",
            any(wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_customize_notice_control_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyone_inc_starter_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/inc/template-tags.php",
            any(wp_content_themes_twentytwentyone_inc_template_tags_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/inc/block-styles.php",
            any(wp_content_themes_twentytwentyone_inc_block_styles_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/inc/template-functions.php",
            any(wp_content_themes_twentytwentyone_inc_template_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/inc/menu-functions.php",
            any(wp_content_themes_twentytwentyone_inc_menu_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/template-parts/footer-menus-widgets.php",
            any(wp_content_themes_twentytwenty_template_parts_footer_menus_widgets_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/search.php",
            any(wp_content_themes_twentytwentyone_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/template-parts/featured-image.php",
            any(wp_content_themes_twentytwenty_template_parts_featured_image_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/template-parts/content.php",
            any(wp_content_themes_twentytwenty_template_parts_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/functions.php",
            any(wp_content_themes_twentytwentyone_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/header.php",
            any(wp_content_themes_twentytwentyone_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyone/404.php",
            any(wp_content_themes_twentytwentyone_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/template-parts/content-cover.php",
            any(wp_content_themes_twentytwenty_template_parts_content_cover_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/template-parts/modal-menu.php",
            any(wp_content_themes_twentytwenty_template_parts_modal_menu_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwenty_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/classes/class-twentytwenty-svg-icons.php",
            any(wp_content_themes_twentytwenty_classes_class_twentytwenty_svg_icons_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/classes/class-twentytwenty-customize.php",
            any(wp_content_themes_twentytwenty_classes_class_twentytwenty_customize_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/footer.php",
            any(wp_content_themes_twentytwenty_footer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/classes/class-twentytwenty-non-latin-languages.php",
            any(wp_content_themes_twentytwenty_classes_class_twentytwenty_non_latin_languages_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/navigation/navigation-top.php",
            any(wp_content_themes_twentyseventeen_template_parts_navigation_navigation_top_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/header/header-image.php",
            any(wp_content_themes_twentyseventeen_template_parts_header_header_image_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/header/site-branding.php",
            any(wp_content_themes_twentyseventeen_template_parts_header_site_branding_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/template-parts/footer/footer-widgets.php",
            any(wp_content_themes_twentyseventeen_template_parts_footer_footer_widgets_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwenty_inc_block_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/inc/starter-content.php",
            any(wp_content_themes_twentytwenty_inc_starter_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/inc/svg-icons.php",
            any(wp_content_themes_twentytwenty_inc_svg_icons_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/inc/template-tags.php",
            any(wp_content_themes_twentytwenty_inc_template_tags_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/functions.php",
            any(wp_content_themes_twentytwenty_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/templates/template-cover.php",
            any(wp_content_themes_twentytwenty_templates_template_cover_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/templates/template-full-width.php",
            any(wp_content_themes_twentytwenty_templates_template_full_width_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/header.php",
            any(wp_content_themes_twentytwenty_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwenty/404.php",
            any(wp_content_themes_twentytwenty_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/loop-page.php",
            any(wp_content_themes_twentyten_loop_page_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/index.php",
            any(wp_content_themes_twentyten_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/archive.php",
            any(wp_content_themes_twentyten_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/loop-single.php",
            any(wp_content_themes_twentyten_loop_single_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyten_onecolumn_page_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/attachment.php",
            any(wp_content_themes_twentyten_attachment_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/search.php",
            any(wp_content_themes_twentyten_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/category.php",
            any(wp_content_themes_twentyten_category_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/functions.php",
            any(wp_content_themes_twentyten_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/header.php",
            any(wp_content_themes_twentyten_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/404.php",
            any(wp_content_themes_twentyten_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/page.php",
            any(wp_content_themes_twentyten_page_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyten_loop_attachment_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/author.php",
            any(wp_content_themes_twentyten_author_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyten/sidebar.php",
            any(wp_content_themes_twentyten_sidebar_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfour_patterns_template_search_blogging_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/cta-services-image-left.php",
            any(wp_content_themes_twentytwentyfour_patterns_cta_services_image_left_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-portfolio-overview.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_portfolio_overview_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-alternating-images.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_alternating_images_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/cta-content-image-on-right.php",
            any(wp_content_themes_twentytwentyfour_patterns_cta_content_image_on_right_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/gallery-offset-images-grid-4-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_4_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-home-portfolio.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_home_portfolio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-about-business.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_about_business_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/posts-images-only-3-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_posts_images_only_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/posts-list.php",
            any(wp_content_themes_twentytwentyfour_patterns_posts_list_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/gallery-offset-images-grid-3-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/posts-1-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_posts_1_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/banner-hero.php",
            any(wp_content_themes_twentytwentyfour_patterns_banner_hero_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-newsletter-landing.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_newsletter_landing_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-faq.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_faq_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-home-blogging.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_home_blogging_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-post-meta.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_post_meta_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-home-business.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_home_business_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-single-portfolio.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_single_portfolio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-no-results.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_no_results_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-feature-grid-3-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_feature_grid_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/gallery-offset-images-grid-2-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_2_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-rsvp-landing.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_rsvp_landing_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/testimonial-centered.php",
            any(wp_content_themes_twentytwentyfour_patterns_testimonial_centered_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-home-blogging.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_home_blogging_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-index-blogging.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_index_blogging_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-project-details.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_project_details_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/index.php",
            any(wp_content_themes_twentyseventeen_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/archive.php",
            any(wp_content_themes_twentyseventeen_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/searchform.php",
            any(wp_content_themes_twentyseventeen_searchform_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/comments.php",
            any(wp_content_themes_twentyseventeen_comments_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyseventeen_inc_icon_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/inc/template-tags.php",
            any(wp_content_themes_twentyseventeen_inc_template_tags_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/inc/template-functions.php",
            any(wp_content_themes_twentyseventeen_inc_template_functions_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyseventeen_footer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyseventeen/sidebar.php",
            any(wp_content_themes_twentyseventeen_sidebar_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/post/discussion-meta.php",
            any(wp_content_themes_twentynineteen_template_parts_post_discussion_meta_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/post/author-bio.php",
            any(wp_content_themes_twentynineteen_template_parts_post_author_bio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/header/entry-header.php",
            any(wp_content_themes_twentynineteen_template_parts_header_entry_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/header/site-branding.php",
            any(wp_content_themes_twentynineteen_template_parts_header_site_branding_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/content/content-none.php",
            any(wp_content_themes_twentynineteen_template_parts_content_content_none_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/content/content-single.php",
            any(wp_content_themes_twentynineteen_template_parts_content_content_single_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/content/content.php",
            any(wp_content_themes_twentynineteen_template_parts_content_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/content/content-excerpt.php",
            any(wp_content_themes_twentynineteen_template_parts_content_content_excerpt_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/content/content-page.php",
            any(wp_content_themes_twentynineteen_template_parts_content_content_page_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/template-parts/footer/footer-widgets.php",
            any(wp_content_themes_twentynineteen_template_parts_footer_footer_widgets_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/index.php",
            any(wp_content_themes_twentynineteen_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/archive.php",
            any(wp_content_themes_twentynineteen_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/comments.php",
            any(wp_content_themes_twentynineteen_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/classes/class-twentynineteen-svg-icons.php",
            any(wp_content_themes_twentynineteen_classes_class_twentynineteen_svg_icons_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/classes/class-twentynineteen-walker-comment.php",
            any(wp_content_themes_twentynineteen_classes_class_twentynineteen_walker_comment_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/single.php",
            any(wp_content_themes_twentynineteen_single_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/back-compat.php",
            any(wp_content_themes_twentynineteen_inc_back_compat_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/customizer.php",
            any(wp_content_themes_twentynineteen_inc_customizer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/block-patterns.php",
            any(wp_content_themes_twentynineteen_inc_block_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/icon-functions.php",
            any(wp_content_themes_twentynineteen_inc_icon_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/helper-functions.php",
            any(wp_content_themes_twentynineteen_inc_helper_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/template-tags.php",
            any(wp_content_themes_twentynineteen_inc_template_tags_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/template-functions.php",
            any(wp_content_themes_twentynineteen_inc_template_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/inc/color-patterns.php",
            any(wp_content_themes_twentynineteen_inc_color_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/search.php",
            any(wp_content_themes_twentynineteen_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/functions.php",
            any(wp_content_themes_twentynineteen_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentynineteen/header.php",
            any(wp_content_themes_twentynineteen_header_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwelve_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/archive.php",
            any(wp_content_themes_twentytwelve_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/sidebar-front.php",
            any(wp_content_themes_twentytwelve_sidebar_front_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/page-templates/front-page.php",
            any(wp_content_themes_twentytwelve_page_templates_front_page_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/page-templates/full-width.php",
            any(wp_content_themes_twentytwelve_page_templates_full_width_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/comments.php",
            any(wp_content_themes_twentytwelve_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/content.php",
            any(wp_content_themes_twentytwelve_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/tag.php",
            any(wp_content_themes_twentytwelve_tag_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/content-status.php",
            any(wp_content_themes_twentytwelve_content_status_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/single.php",
            any(wp_content_themes_twentytwelve_single_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/inc/custom-header.php",
            any(wp_content_themes_twentytwelve_inc_custom_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/inc/block-patterns.php",
            any(wp_content_themes_twentytwelve_inc_block_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/search.php",
            any(wp_content_themes_twentytwelve_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwelve/category.php",
            any(wp_content_themes_twentytwelve_category_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwelve_content_link_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/index.php",
            any(wp_content_themes_twentytwentytwo_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-image-background.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_image_background_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-centered-title-navigation-social.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_header_centered_title_navigation_social_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-title-navigation-social.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_title_navigation_social_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-centered-logo-black-background.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_header_centered_logo_black_background_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-layout-two-columns.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_layout_two_columns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-large-list-names.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_large_list_names_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-divider-light.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_divider_light_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-default.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_default_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-logo-navigation-social-black-background.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_header_logo_navigation_social_black_background_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-video-header-details.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_video_header_details_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-navigation-copyright.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_navigation_copyright_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-title-and-button.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_title_and_button_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-centered-logo.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_centered_logo_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-video-trailer.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_video_trailer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-query-title-citation.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_query_title_citation_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-wide-image-intro-buttons.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_general_wide_image_intro_buttons_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-about-media-left.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_about_media_left_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-featured-posts.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_featured_posts_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-layout-image-and-text.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_layout_image_and_text_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/query-large-titles.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_large_titles_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-small-dark.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_small_dark_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-divider-dark.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_divider_dark_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-text-only-salmon-background.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_header_text_only_salmon_background_live_dispatch,
            ),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_subscribe_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-query-images-title-citation.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_footer_query_images_title_citation_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/hidden-heading-and-bird.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_hidden_heading_and_bird_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/query-default.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_default_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/query-simple-blog.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_simple_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-logo.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_logo_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-list-events.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_list_events_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-default.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_default_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/query-text-grid.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_text_grid_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-sidebar-blog-posts-right.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_page_sidebar_blog_posts_right_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-layout-image-text-and-video.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_page_layout_image_text_and_video_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-dark.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_dark_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-two-images-text.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_two_images_text_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-sidebar-grid-posts.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_sidebar_grid_posts_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-about-links.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_about_links_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/query-image-grid.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_image_grid_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-navigation.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_navigation_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/page-about-links-dark.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_about_links_dark_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-stacked.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_stacked_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentytwo_inc_patterns_page_about_solid_color_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/hidden-404.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_hidden_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-logo-navigation-gray-background.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_header_logo_navigation_gray_background_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/header-with-tagline.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_header_with_tagline_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-layered-images-with-duotone.php",
            any(
                wp_content_themes_twentytwentytwo_inc_patterns_general_layered_images_with_duotone_live_dispatch,
            ),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentytwo_inc_patterns_query_irregular_grid_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/general-pricing-table.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_general_pricing_table_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/patterns/footer-blog.php",
            any(wp_content_themes_twentytwentytwo_inc_patterns_footer_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/inc/block-patterns.php",
            any(wp_content_themes_twentytwentytwo_inc_block_patterns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentytwo/functions.php",
            any(wp_content_themes_twentytwentytwo_functions_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfour_patterns_page_home_portfolio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/posts-3-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_posts_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-title-left-image-right.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_title_left_image_right_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-sidebar.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_sidebar_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-home-portfolio-gallery.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_home_portfolio_gallery_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/gallery-project-layout.php",
            any(wp_content_themes_twentytwentyfour_patterns_gallery_project_layout_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/cta-rsvp.php",
            any(wp_content_themes_twentytwentyfour_patterns_cta_rsvp_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-search.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-archive-blogging.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_archive_blogging_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/posts-images-only-offset-4-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_posts_images_only_offset_4_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/page-home-business.php",
            any(wp_content_themes_twentytwentyfour_patterns_page_home_business_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-portfolio-hero.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_portfolio_hero_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/footer-centered-logo-nav.php",
            any(wp_content_themes_twentytwentyfour_patterns_footer_centered_logo_nav_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-posts-heading.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_posts_heading_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-index-portfolio.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_index_portfolio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-centered-statement.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_centered_statement_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/template-archive-portfolio.php",
            any(wp_content_themes_twentytwentyfour_patterns_template_archive_portfolio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/cta-subscribe-centered.php",
            any(wp_content_themes_twentytwentyfour_patterns_cta_subscribe_centered_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-post-navigation.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_post_navigation_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/footer-colophon-3-col.php",
            any(wp_content_themes_twentytwentyfour_patterns_footer_colophon_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/footer.php",
            any(wp_content_themes_twentytwentyfour_patterns_footer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/cta-pricing.php",
            any(wp_content_themes_twentytwentyfour_patterns_cta_pricing_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/text-centered-statement-small.php",
            any(wp_content_themes_twentytwentyfour_patterns_text_centered_statement_small_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/patterns/hidden-404.php",
            any(wp_content_themes_twentytwentyfour_patterns_hidden_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfour/functions.php",
            any(wp_content_themes_twentytwentyfour_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-news-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_single_news_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-photo-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_single_photo_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-search-news-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_search_news_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hero-book.php",
            any(wp_content_themes_twentytwentyfive_patterns_hero_book_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfive_patterns_page_business_home_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-search-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_search_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_home_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/grid-videos.php",
            any(wp_content_themes_twentytwentyfive_patterns_grid_videos_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hidden-written-by.php",
            any(wp_content_themes_twentytwentyfive_patterns_hidden_written_by_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hero-podcast.php",
            any(wp_content_themes_twentytwentyfive_patterns_hero_podcast_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/banner-with-description-and-images-grid.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_banner_with_description_and_images_grid_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/banner-poster.php",
            any(wp_content_themes_twentytwentyfive_patterns_banner_poster_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/header-centered.php",
            any(wp_content_themes_twentytwentyfive_patterns_header_centered_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/header-columns.php",
            any(wp_content_themes_twentytwentyfive_patterns_header_columns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/cta-grid-products-link.php",
            any(wp_content_themes_twentytwentyfive_patterns_cta_grid_products_link_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-news-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_query_loop_news_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/format-audio.php",
            any(wp_content_themes_twentytwentyfive_patterns_format_audio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-posts-grid-news-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_home_posts_grid_news_blog_live_dispatch,
            ),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfive_patterns_page_landing_event_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/pricing-3-col.php",
            any(wp_content_themes_twentytwentyfive_patterns_pricing_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/more-posts.php",
            any(wp_content_themes_twentytwentyfive_patterns_more_posts_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-search-photo-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_search_photo_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/page-shop-home.php",
            any(wp_content_themes_twentytwentyfive_patterns_page_shop_home_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/heading-and-paragraph-with-image.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_heading_and_paragraph_with_image_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/cta-heading-search.php",
            any(wp_content_themes_twentytwentyfive_patterns_cta_heading_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/footer-columns.php",
            any(wp_content_themes_twentytwentyfive_patterns_footer_columns_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-photo-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_query_loop_photo_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-news-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_home_news_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-page-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_page_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-offset.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_single_offset_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/page-link-in-bio-heading-paragraph-links-image.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_page_link_in_bio_heading_paragraph_links_image_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_single_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-archive-photo-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_archive_photo_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/vertical-header.php",
            any(wp_content_themes_twentytwentyfive_patterns_vertical_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/page-portfolio-home.php",
            any(wp_content_themes_twentytwentyfive_patterns_page_portfolio_home_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hidden-blog-heading.php",
            any(wp_content_themes_twentytwentyfive_patterns_hidden_blog_heading_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/grid-with-categories.php",
            any(wp_content_themes_twentytwentyfive_patterns_grid_with_categories_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/event-3-col.php",
            any(wp_content_themes_twentytwentyfive_patterns_event_3_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-archive-text-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_archive_text_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/page-link-in-bio-with-tight-margins.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_page_link_in_bio_with_tight_margins_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/services-subscriber-only-section.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_services_subscriber_only_section_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-photo-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_home_photo_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/footer-social.php",
            any(wp_content_themes_twentytwentyfive_patterns_footer_social_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-search-text-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_search_text_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-404-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_404_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-archive-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_archive_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/banner-intro.php",
            any(wp_content_themes_twentytwentyfive_patterns_banner_intro_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/format-link.php",
            any(wp_content_themes_twentytwentyfive_patterns_format_link_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hidden-search.php",
            any(wp_content_themes_twentytwentyfive_patterns_hidden_search_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/overlapped-images.php",
            any(wp_content_themes_twentytwentyfive_patterns_overlapped_images_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/header.php",
            any(wp_content_themes_twentytwentyfive_patterns_header_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-text-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_query_loop_text_blog_live_dispatch,
            ),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfive_patterns_post_navigation_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/logos.php",
            any(wp_content_themes_twentytwentyfive_patterns_logos_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hidden-404.php",
            any(wp_content_themes_twentytwentyfive_patterns_hidden_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/cta-events-list.php",
            any(wp_content_themes_twentytwentyfive_patterns_cta_events_list_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/cta-centered-heading.php",
            any(wp_content_themes_twentytwentyfive_patterns_cta_centered_heading_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-left-aligned-content.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_single_left_aligned_content_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-page-photo-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_page_photo_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-query-loop-vertical-header-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_query_loop_vertical_header_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/event-schedule.php",
            any(wp_content_themes_twentytwentyfive_patterns_event_schedule_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/testimonials-6-col.php",
            any(wp_content_themes_twentytwentyfive_patterns_testimonials_6_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/footer-centered.php",
            any(wp_content_themes_twentytwentyfive_patterns_footer_centered_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/header-large-title.php",
            any(wp_content_themes_twentytwentyfive_patterns_header_large_title_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-home-text-blog.php",
            any(wp_content_themes_twentytwentyfive_patterns_template_home_text_blog_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/contact-info-locations.php",
            any(wp_content_themes_twentytwentyfive_patterns_contact_info_locations_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfive_functions_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content-none.php",
            any(wp_content_themes_twentyfourteen_content_none_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content-aside.php",
            any(wp_content_themes_twentyfourteen_content_aside_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/index.php",
            any(wp_content_themes_twentyfourteen_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/archive.php",
            any(wp_content_themes_twentyfourteen_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content-audio.php",
            any(wp_content_themes_twentyfourteen_content_audio_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentythree/patterns/hidden-comments.php",
            any(wp_content_themes_twentytwentythree_patterns_hidden_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentythree/patterns/footer-default.php",
            any(wp_content_themes_twentytwentythree_patterns_footer_default_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentythree/patterns/hidden-no-results.php",
            any(wp_content_themes_twentytwentythree_patterns_hidden_no_results_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyfourteen_page_templates_contributors_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/page-templates/full-width.php",
            any(wp_content_themes_twentyfourteen_page_templates_full_width_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/comments.php",
            any(wp_content_themes_twentyfourteen_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content.php",
            any(wp_content_themes_twentyfourteen_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentythree/patterns/hidden-404.php",
            any(wp_content_themes_twentytwentythree_patterns_hidden_404_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/tag.php",
            any(wp_content_themes_twentyfourteen_tag_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/featured-content.php",
            any(wp_content_themes_twentyfourteen_featured_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/sidebar-footer.php",
            any(wp_content_themes_twentyfourteen_sidebar_footer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/single.php",
            any(wp_content_themes_twentyfourteen_single_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyfourteen_author_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content-image.php",
            any(wp_content_themes_twentyfourteen_content_image_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/content-quote.php",
            any(wp_content_themes_twentyfourteen_content_quote_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/sidebar.php",
            any(wp_content_themes_twentyfourteen_sidebar_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentyfourteen_inc_template_tags_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentyfourteen/inc/block-patterns.php",
            any(wp_content_themes_twentyfourteen_inc_block_patterns_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentytwentyfive_patterns_testimonials_2_col_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/media-instagram-grid.php",
            any(wp_content_themes_twentytwentyfive_patterns_media_instagram_grid_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/template-single-text-blog.php",
            any(
                wp_content_themes_twentytwentyfive_patterns_template_single_text_blog_live_dispatch,
            ),
        )
        .route(
            "/wp-content/themes/twentytwentyfive/patterns/hidden-sidebar.php",
            any(wp_content_themes_twentytwentyfive_patterns_hidden_sidebar_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentythirteen_footer_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/author.php",
            any(wp_content_themes_twentythirteen_author_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/content-image.php",
            any(wp_content_themes_twentythirteen_content_image_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/content-quote.php",
            any(wp_content_themes_twentythirteen_content_quote_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/sidebar.php",
            any(wp_content_themes_twentythirteen_sidebar_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/content-link.php",
            any(wp_content_themes_twentythirteen_content_link_live_dispatch),
        )
        .route(
        ...
        .route(
            ...
            any(wp_content_themes_twentythirteen_content_aside_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/index.php",
            any(wp_content_themes_twentythirteen_index_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/archive.php",
            any(wp_content_themes_twentythirteen_archive_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/comments.php",
            any(wp_content_themes_twentythirteen_comments_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/content.php",
            any(wp_content_themes_twentythirteen_content_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/tag.php",
            any(wp_content_themes_twentythirteen_tag_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/sidebar-main.php",
            any(wp_content_themes_twentythirteen_sidebar_main_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/content-status.php",
            any(wp_content_themes_twentythirteen_content_status_live_dispatch),
        )
        .route(
            "/wp-content/themes/twentythirteen/single.php",
            any(wp_content_themes_twentythirteen_single_live_dispatch),
        )
        .route(
...
async fn wp_content_themes_twentyseventeen_template_parts_post_content_gallery_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_post_content_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_page_content_front_page_panels_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_page_content_front_page_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_page_content_page_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyeleven_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyeleven_inc_widgets_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyeleven_inc_theme_options_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyeleven_search_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyone_template_parts_header_entry_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_header_site_nav_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_header_site_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_header_excerpt_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyone_template_parts_footer_footer_widgets_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_audio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_status_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_link_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_chat_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_template_parts_excerpt_excerpt_quote_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_customize_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_custom_colors_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_dark_mode_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_classes_class_twenty_twenty_one_customize_notice_control_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyone_inc_starter_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_inc_template_tags_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_inc_block_styles_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_inc_template_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_inc_menu_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_template_parts_footer_menus_widgets_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_search_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_template_parts_featured_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_template_parts_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_header_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyone_404_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_template_parts_content_cover_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_template_parts_modal_menu_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwenty_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_classes_class_twentytwenty_svg_icons_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_classes_class_twentytwenty_customize_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_footer_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_classes_class_twentytwenty_non_latin_languages_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_navigation_navigation_top_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_header_header_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_header_site_branding_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_template_parts_footer_footer_widgets_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwenty_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_inc_starter_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_inc_svg_icons_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_inc_template_tags_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_templates_template_cover_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_templates_template_full_width_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_header_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwenty_404_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_loop_page_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_loop_single_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyten_onecolumn_page_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_attachment_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_search_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_category_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_header_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_404_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_page_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyten_loop_attachment_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_author_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyten_sidebar_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyfour_patterns_template_search_blogging_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_cta_services_image_left_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_portfolio_overview_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_alternating_images_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_cta_content_image_on_right_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_4_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_home_portfolio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_about_business_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_posts_images_only_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_posts_list_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_posts_1_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_banner_hero_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_newsletter_landing_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_faq_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_home_blogging_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_post_meta_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_home_business_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_single_portfolio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_no_results_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_feature_grid_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_gallery_offset_images_grid_2_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_rsvp_landing_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_testimonial_centered_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_home_blogging_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_index_blogging_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_project_details_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_searchform_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyseventeen_inc_icon_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_inc_template_tags_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_inc_template_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyseventeen_footer_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyseventeen_sidebar_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_post_discussion_meta_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_post_author_bio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_header_entry_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_header_site_branding_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_content_content_none_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_content_content_single_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_content_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_content_content_excerpt_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_content_content_page_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_template_parts_footer_footer_widgets_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_classes_class_twentynineteen_svg_icons_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_classes_class_twentynineteen_walker_comment_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_single_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_back_compat_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_customizer_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_icon_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_helper_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_template_tags_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_template_functions_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_inc_color_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_search_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentynineteen_header_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwelve_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_sidebar_front_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_page_templates_front_page_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_page_templates_full_width_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_content_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_tag_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_content_status_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_single_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_inc_custom_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_search_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwelve_category_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwelve_content_link_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_image_background_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_centered_title_navigation_social_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_title_navigation_social_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_centered_logo_black_background_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_layout_two_columns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_large_list_names_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_divider_light_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_default_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_logo_navigation_social_black_background_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_video_header_details_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_navigation_copyright_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_title_and_button_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_centered_logo_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_video_trailer_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_query_title_citation_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_wide_image_intro_buttons_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_about_media_left_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_featured_posts_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_layout_image_and_text_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_query_large_titles_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_small_dark_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_divider_dark_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentytwo_inc_patterns_general_subscribe_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_query_images_title_citation_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_hidden_heading_and_bird_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_query_default_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_query_simple_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_logo_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_list_events_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_default_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_query_text_grid_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_sidebar_blog_posts_right_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_layout_image_text_and_video_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_dark_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_two_images_text_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_sidebar_grid_posts_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_about_links_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_query_image_grid_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_navigation_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_page_about_links_dark_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_stacked_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentytwo_inc_patterns_page_about_solid_color_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_hidden_404_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_logo_navigation_gray_background_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_header_with_tagline_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentytwo_inc_patterns_query_irregular_grid_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_general_pricing_table_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_patterns_footer_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentytwo_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_banner_project_description_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_home_portfolio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_posts_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_title_left_image_right_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_sidebar_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_home_portfolio_gallery_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_gallery_project_layout_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_cta_rsvp_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_search_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_archive_blogging_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_posts_images_only_offset_4_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_page_home_business_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_portfolio_hero_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_footer_centered_logo_nav_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_posts_heading_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_index_portfolio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_centered_statement_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_template_archive_portfolio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_cta_subscribe_centered_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_post_navigation_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_footer_colophon_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_footer_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_cta_pricing_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_text_centered_statement_small_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_patterns_hidden_404_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfour_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_news_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_search_news_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hero_book_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyfive_patterns_page_business_home_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_search_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_home_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_grid_videos_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hidden_written_by_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hero_podcast_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_banner_with_description_and_images_grid_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_banner_poster_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_header_centered_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_header_columns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_cta_grid_products_link_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_query_loop_news_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_format_audio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_home_posts_grid_news_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyfive_patterns_page_landing_event_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_pricing_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_more_posts_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_search_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_page_shop_home_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_heading_and_paragraph_with_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_cta_heading_search_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_footer_columns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_query_loop_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_home_news_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_page_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_offset_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_page_link_in_bio_heading_paragraph_links_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_archive_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_vertical_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_page_portfolio_home_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hidden_blog_heading_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_grid_with_categories_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_event_3_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_archive_text_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_page_link_in_bio_with_tight_margins_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_services_subscriber_only_section_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_home_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_footer_social_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_search_text_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_404_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_archive_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_banner_intro_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_format_link_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hidden_search_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_overlapped_images_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_header_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_query_loop_text_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyfive_patterns_post_navigation_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_logos_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hidden_404_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_cta_events_list_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_cta_centered_heading_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_left_aligned_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_page_photo_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_query_loop_vertical_header_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_event_schedule_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_testimonials_6_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_footer_centered_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_header_large_title_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_home_text_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_contact_info_locations_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentytwentyfive_functions_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_none_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_aside_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_audio_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentythree_patterns_hidden_comments_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentythree_patterns_footer_default_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentythree_patterns_hidden_no_results_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyfourteen_page_templates_contributors_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_page_templates_full_width_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentythree_patterns_hidden_404_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_tag_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_featured_content_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_sidebar_footer_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_single_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyfourteen_author_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_content_quote_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_sidebar_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentyfourteen_inc_template_tags_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentyfourteen_inc_block_patterns_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_footer_newsletter_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_testimonials_2_col_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_media_instagram_grid_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_template_single_text_blog_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentytwentyfive_patterns_hidden_sidebar_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}
...
async fn wp_content_themes_twentythirteen_footer_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_author_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_image_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_quote_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_sidebar_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_link_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_none_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_aside_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_index_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_archive_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_comments_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_tag_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_sidebar_main_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_content_status_live_dispatch(
    _request: Request,
) -> Response {
    legacy_admin_include_empty_response()
}

async fn wp_content_themes_twentythirteen_single_live_dispatch(_request: Request) -> Response {
    legacy_admin_include_empty_response()
}
    ...
    if mode.eq_ignore_ascii_case("accepted_args") {
        ...
        dispatcher.add_filter_with_accepted_args(
            ...
            Box::new(|value, args| {
                ...
                Value::String(format!("{current}|{first}"))
            }),
        );
        let filtered = dispatcher.apply_filters(
            "the_content",
...
async fn internal_constants(Query(query): Query<InternalConstantsQuery>) -> impl IntoResponse {
    ...
    rust_handled_json(json!({
        ...
        "constants": {
            ...
            "wp_debug_log_path": constants.wp_debug_log_path,
...
mod tests {
    ...
    async fn internal_xmlrpc_dispatch_enforces_new_post_authentication() {
        let anonymous_response = internal_xmlrpc_dispatch(
            ...
            Query(InternalXmlRpcDispatchQuery {
                method: Some("wp.newPost".to_string()),
                payload: None,
                authenticated: Some(false),
                use_cookie_auth: None,
            }),
    ...
    #[tokio::test]
    async fn internal_xmlrpc_dispatch_parses_method_tags_with_whitespace() {
        let response = internal_xmlrpc_dispatch(
            State(build_app_state()),
            Query(InternalXmlRpcDispatchQuery {
                method: None,
    ...
    #[tokio::test]
    async fn internal_xmlrpc_dispatch_parses_method_tags_with_attributes() {
        let response = internal_xmlrpc_dispatch(
            State(build_app_state()),
            Query(InternalXmlRpcDispatchQuery {
                method: None,
                payload: Some(
                    "<methodCall><methodName type=\"string\">demo.sayHello</methodName></methodCall>"
                        .to_string(),
                ),
                authenticated: Some(false),
                use_cookie_auth: None,
    ...
    async fn constants_include_debug_log_path_when_provided() {
        let response = internal_constants(Query(InternalConstantsQuery {
            ...
            wp_debug_log: Some("/tmp/debug.log".to_string()),
            wp_cache: None,
            script_debug: None,
            media_trash: None,
            shortinit: None,
    ...
    #[tokio::test]
    async fn constants_parse_terabyte_and_petabyte_memory_sizes() {
        let response = internal_constants(Query(InternalConstantsQuery {
            wp_environment_type: None,
            wp_debug: None,
            wp_version: None,
            ...
            wp_lang_dir: None,
            wp_temp_dir: None,
            wp_memory_limit: Some("1T".to_string()),
            wp_max_memory_limit: Some("1PB".to_string()),
            autosave_interval: None,
            empty_trash_days: None,
            wp_post_revisions: None,
            wp_cron_lock_timeout: None,
        ...
        .into_response();
        let json = response_json(response).await;
        assert_eq!(json["memory_limit_bytes"], Value::from(1024_u64.pow(4)));
        assert_eq!(json["max_memory_limit_bytes"], Value::from(1024_u64.pow(5)));
    }
    ...
    #[tokio::test]
    async fn multisite_resolve_handles_duplicate_slashes_in_request_path() {
        let state = build_app_state();
        let response = internal_multisite_resolve(
            State(state),
            Query(InternalMultisiteResolveQuery {
                domain: Some("example.com".to_string()),
                path: Some("//blog//hello-world".to_string()),
            }),
        )
        .await
        .into_response();
    ...
    #[tokio::test]
    async fn multisite_resolve_prefers_root_site_for_sibling_prefix_path() {
        let state = build_app_state();
        let response = internal_multisite_resolve(
            State(state),
            Query(InternalMultisiteResolveQuery {
                domain: Some("example.com".to_string()),
                path: Some("/blogger/post".to_string()),
            }),
        )
        .await
        .into_response();
