...
if ( wp_rust_gateway_current_request_path( '/wp-includes/feed-atom-comments.php' ) === '/wp-includes/feed-atom-comments.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/feed-atom-comments.php' ) ) {
	exit;
}
