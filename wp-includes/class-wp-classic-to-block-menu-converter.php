...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-wp-classic-to-block-menu-converter.php' ) === '/wp-includes/class-wp-classic-to-block-menu-converter.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-wp-classic-to-block-menu-converter.php' ) ) {
	exit;
}
