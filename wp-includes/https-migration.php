...
if ( wp_rust_gateway_current_request_path( '/wp-includes/https-migration.php' ) === '/wp-includes/https-migration.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/https-migration.php' ) ) {
	exit;
}
