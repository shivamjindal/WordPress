...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/IXR/class-IXR-server.php' );
if ( '/wp-includes/IXR/class-IXR-server.php' === $rust_gateway_request_path
