...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/IXR/class-IXR-date.php' );
if ( '/wp-includes/IXR/class-IXR-date.php' === $rust_gateway_request_path
