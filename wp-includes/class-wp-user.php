...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-wp-user.php' ) === '/wp-includes/class-wp-user.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-wp-user.php' ) ) {
	exit;
}
