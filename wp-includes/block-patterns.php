...
if ( wp_rust_gateway_current_request_path( '/wp-includes/block-patterns.php' ) === '/wp-includes/block-patterns.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/block-patterns.php' ) ) {
	exit;
}
