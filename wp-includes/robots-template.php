...
if ( wp_rust_gateway_current_request_path( '/wp-includes/robots-template.php' ) === '/wp-includes/robots-template.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/robots-template.php' ) ) {
	exit;
}
