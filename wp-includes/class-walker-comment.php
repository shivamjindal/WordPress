...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-walker-comment.php' ) === '/wp-includes/class-walker-comment.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-walker-comment.php' ) ) {
	exit;
}
