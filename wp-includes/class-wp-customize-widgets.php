...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-wp-customize-widgets.php' ) === '/wp-includes/class-wp-customize-widgets.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-wp-customize-widgets.php' ) ) {
	exit;
}
