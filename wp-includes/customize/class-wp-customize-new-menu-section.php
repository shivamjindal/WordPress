...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/customize/class-wp-customize-new-menu-section.php' );
if ( '/wp-includes/customize/class-wp-customize-new-menu-section.php' === $rust_gateway_request_path
