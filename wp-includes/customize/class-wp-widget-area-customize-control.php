...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/customize/class-wp-widget-area-customize-control.php' );
if ( '/wp-includes/customize/class-wp-widget-area-customize-control.php' === $rust_gateway_request_path
