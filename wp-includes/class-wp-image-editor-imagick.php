...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-wp-image-editor-imagick.php' ) === '/wp-includes/class-wp-image-editor-imagick.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-wp-image-editor-imagick.php' ) ) {
	exit;
}
