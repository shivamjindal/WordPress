...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/rest-api/endpoints/class-wp-rest-site-health-controller.php' );
if ( '/wp-includes/rest-api/endpoints/class-wp-rest-site-health-controller.php' === $rust_gateway_request_path
