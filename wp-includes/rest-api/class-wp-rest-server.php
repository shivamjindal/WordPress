...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/rest-api/class-wp-rest-server.php' );
if ( '/wp-includes/rest-api/class-wp-rest-server.php' === $rust_gateway_request_path
