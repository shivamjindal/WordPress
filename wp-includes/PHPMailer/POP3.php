...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/PHPMailer/POP3.php' );
if ( '/wp-includes/PHPMailer/POP3.php' === $rust_gateway_request_path
