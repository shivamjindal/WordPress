...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/PHPMailer/SMTP.php' );
if ( '/wp-includes/PHPMailer/SMTP.php' === $rust_gateway_request_path
