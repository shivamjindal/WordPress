...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/js/dist/script-modules/index.php' );
if ( '/wp-includes/js/dist/script-modules/index.php' === $rust_gateway_request_path
