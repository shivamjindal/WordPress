...
if ( wp_rust_gateway_current_request_path( '/wp-includes/speculative-loading.php' ) === '/wp-includes/speculative-loading.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/speculative-loading.php' ) ) {
	exit;
}
