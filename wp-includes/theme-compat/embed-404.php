...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/theme-compat/embed-404.php' );
if ( '/wp-includes/theme-compat/embed-404.php' === $rust_gateway_request_path
