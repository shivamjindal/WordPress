...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/style-engine/class-wp-style-engine-css-rule.php' );
if ( '/wp-includes/style-engine/class-wp-style-engine-css-rule.php' === $rust_gateway_request_path
