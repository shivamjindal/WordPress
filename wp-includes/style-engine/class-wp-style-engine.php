...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/style-engine/class-wp-style-engine.php' );
if ( '/wp-includes/style-engine/class-wp-style-engine.php' === $rust_gateway_request_path
