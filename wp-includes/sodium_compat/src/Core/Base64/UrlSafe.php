...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/sodium_compat/src/Core/Base64/UrlSafe.php' );
if ( '/wp-includes/sodium_compat/src/Core/Base64/UrlSafe.php' === $rust_gateway_request_path
