...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/sodium_compat/src/Core32/SipHash.php' );
if ( '/wp-includes/sodium_compat/src/Core32/SipHash.php' === $rust_gateway_request_path
