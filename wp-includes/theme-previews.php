...
if ( wp_rust_gateway_current_request_path( '/wp-includes/theme-previews.php' ) === '/wp-includes/theme-previews.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/theme-previews.php' ) ) {
	exit;
}
