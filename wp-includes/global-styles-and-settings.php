...
if ( wp_rust_gateway_current_request_path( '/wp-includes/global-styles-and-settings.php' ) === '/wp-includes/global-styles-and-settings.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/global-styles-and-settings.php' ) ) {
	exit;
}
