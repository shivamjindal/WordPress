...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/fonts/class-wp-font-utils.php' );
if ( '/wp-includes/fonts/class-wp-font-utils.php' === $rust_gateway_request_path
