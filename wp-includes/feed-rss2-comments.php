...
if ( wp_rust_gateway_current_request_path( '/wp-includes/feed-rss2-comments.php' ) === '/wp-includes/feed-rss2-comments.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/feed-rss2-comments.php' ) ) {
	exit;
}
