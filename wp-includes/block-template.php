...
if ( wp_rust_gateway_current_request_path( '/wp-includes/block-template.php' ) === '/wp-includes/block-template.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/block-template.php' ) ) {
	exit;
}
