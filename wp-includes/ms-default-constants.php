...
if ( wp_rust_gateway_current_request_path( '/wp-includes/ms-default-constants.php' ) === '/wp-includes/ms-default-constants.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/ms-default-constants.php' ) ) {
	exit;
}
