...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Requests/src/Session.php' );
if ( '/wp-includes/Requests/src/Session.php' === $rust_gateway_request_path
