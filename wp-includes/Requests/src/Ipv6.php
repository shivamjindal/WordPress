...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Requests/src/Ipv6.php' );
if ( '/wp-includes/Requests/src/Ipv6.php' === $rust_gateway_request_path
