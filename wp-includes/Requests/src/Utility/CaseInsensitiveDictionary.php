...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Requests/src/Utility/CaseInsensitiveDictionary.php' );
if ( '/wp-includes/Requests/src/Utility/CaseInsensitiveDictionary.php' === $rust_gateway_request_path
