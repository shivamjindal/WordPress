...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Requests/src/Transport/Fsockopen.php' );
if ( '/wp-includes/Requests/src/Transport/Fsockopen.php' === $rust_gateway_request_path
