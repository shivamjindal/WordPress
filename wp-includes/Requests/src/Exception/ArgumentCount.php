...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Requests/src/Exception/ArgumentCount.php' );
if ( '/wp-includes/Requests/src/Exception/ArgumentCount.php' === $rust_gateway_request_path
