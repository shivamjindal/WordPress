...
if ( wp_rust_gateway_current_request_path( '/wp-includes/script-loader.php' ) === '/wp-includes/script-loader.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/script-loader.php' ) ) {
	exit;
}
