...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-walker-nav-menu.php' ) === '/wp-includes/class-walker-nav-menu.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-walker-nav-menu.php' ) ) {
	exit;
}
