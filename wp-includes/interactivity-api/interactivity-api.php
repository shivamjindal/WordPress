...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/interactivity-api/interactivity-api.php' );
if ( '/wp-includes/interactivity-api/interactivity-api.php' === $rust_gateway_request_path
