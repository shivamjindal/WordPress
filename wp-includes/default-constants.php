...
if ( wp_rust_gateway_current_request_path( '/wp-includes/default-constants.php' ) === '/wp-includes/default-constants.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/default-constants.php' ) ) {
	exit;
}
