...
if ( wp_rust_gateway_current_request_path( '/wp-includes/ms-functions.php' ) === '/wp-includes/ms-functions.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/ms-functions.php' ) ) {
	exit;
}
