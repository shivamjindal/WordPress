...
if ( wp_rust_gateway_current_request_path( '/wp-includes/post-formats.php' ) === '/wp-includes/post-formats.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/post-formats.php' ) ) {
	exit;
}
