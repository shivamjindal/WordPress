...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/block-supports/typography.php' );
if ( '/wp-includes/block-supports/typography.php' === $rust_gateway_request_path
