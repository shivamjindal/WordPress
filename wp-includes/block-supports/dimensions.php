...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/block-supports/dimensions.php' );
if ( '/wp-includes/block-supports/dimensions.php' === $rust_gateway_request_path
