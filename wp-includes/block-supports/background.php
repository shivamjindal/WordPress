...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/block-supports/background.php' );
if ( '/wp-includes/block-supports/background.php' === $rust_gateway_request_path
