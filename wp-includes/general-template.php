...
if ( wp_rust_gateway_current_request_path( '/wp-includes/general-template.php' ) === '/wp-includes/general-template.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/general-template.php' ) ) {
	exit;
}
