...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/widgets/class-wp-nav-menu-widget.php' );
if ( '/wp-includes/widgets/class-wp-nav-menu-widget.php' === $rust_gateway_request_path
