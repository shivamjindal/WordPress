...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/widgets/class-wp-widget-links.php' );
if ( '/wp-includes/widgets/class-wp-widget-links.php' === $rust_gateway_request_path
