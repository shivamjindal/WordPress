...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/widgets/class-wp-widget-media.php' );
if ( '/wp-includes/widgets/class-wp-widget-media.php' === $rust_gateway_request_path
