...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/widgets/class-wp-widget-media-gallery.php' );
if ( '/wp-includes/widgets/class-wp-widget-media-gallery.php' === $rust_gateway_request_path
