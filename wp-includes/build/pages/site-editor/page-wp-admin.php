...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/build/pages/site-editor/page-wp-admin.php' );
if ( '/wp-includes/build/pages/site-editor/page-wp-admin.php' === $rust_gateway_request_path
