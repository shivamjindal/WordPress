...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/html-api/class-wp-html-token.php' );
if ( '/wp-includes/html-api/class-wp-html-token.php' === $rust_gateway_request_path
