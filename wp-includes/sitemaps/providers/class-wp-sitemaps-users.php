...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/sitemaps/providers/class-wp-sitemaps-users.php' );
if ( '/wp-includes/sitemaps/providers/class-wp-sitemaps-users.php' === $rust_gateway_request_path
