...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Text/Diff/Renderer/inline.php' );
if ( '/wp-includes/Text/Diff/Renderer/inline.php' === $rust_gateway_request_path
