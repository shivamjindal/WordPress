...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/Text/Diff/Engine/shell.php' );
if ( '/wp-includes/Text/Diff/Engine/shell.php' === $rust_gateway_request_path
