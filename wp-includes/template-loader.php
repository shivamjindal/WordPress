...
if ( wp_rust_gateway_current_request_path( '/wp-includes/template-loader.php' ) === '/wp-includes/template-loader.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/template-loader.php' ) ) {
	exit;
}
