...
if ( wp_rust_gateway_current_request_path( '/wp-includes/default-filters.php' ) === '/wp-includes/default-filters.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/default-filters.php' ) ) {
	exit;
}
