...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/assets/script-modules-packages.min.php' );
if ( '/wp-includes/assets/script-modules-packages.min.php' === $rust_gateway_request_path
