...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-phpmailer.php' ) === '/wp-includes/class-phpmailer.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-phpmailer.php' ) ) {
	exit;
}
