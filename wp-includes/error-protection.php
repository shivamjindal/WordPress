...
if ( wp_rust_gateway_current_request_path( '/wp-includes/error-protection.php' ) === '/wp-includes/error-protection.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/error-protection.php' ) ) {
	exit;
}
