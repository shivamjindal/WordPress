...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/block-bindings/term-data.php' );
if ( '/wp-includes/block-bindings/term-data.php' === $rust_gateway_request_path
