...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/block-bindings/pattern-overrides.php' );
if ( '/wp-includes/block-bindings/pattern-overrides.php' === $rust_gateway_request_path
