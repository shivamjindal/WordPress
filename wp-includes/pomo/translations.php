...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/pomo/translations.php' );
if ( '/wp-includes/pomo/translations.php' === $rust_gateway_request_path
