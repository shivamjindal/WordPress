...
if ( wp_rust_gateway_current_request_path( '/wp-includes/block-editor.php' ) === '/wp-includes/block-editor.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/block-editor.php' ) ) {
	exit;
}
