...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/library/SimplePie/Rating.php' );
if ( '/wp-includes/SimplePie/library/SimplePie/Rating.php' === $rust_gateway_request_path
