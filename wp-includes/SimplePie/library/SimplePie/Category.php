...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/library/SimplePie/Category.php' );
if ( '/wp-includes/SimplePie/library/SimplePie/Category.php' === $rust_gateway_request_path
