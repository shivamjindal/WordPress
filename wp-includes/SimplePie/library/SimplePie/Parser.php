...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/library/SimplePie/Parser.php' );
if ( '/wp-includes/SimplePie/library/SimplePie/Parser.php' === $rust_gateway_request_path
