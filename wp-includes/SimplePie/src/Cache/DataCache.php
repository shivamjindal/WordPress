...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/src/Cache/DataCache.php' );
if ( '/wp-includes/SimplePie/src/Cache/DataCache.php' === $rust_gateway_request_path
