...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/src/Cache/File.php' );
if ( '/wp-includes/SimplePie/src/Cache/File.php' === $rust_gateway_request_path
