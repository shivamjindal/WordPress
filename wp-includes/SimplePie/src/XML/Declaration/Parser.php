...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/src/XML/Declaration/Parser.php' );
if ( '/wp-includes/SimplePie/src/XML/Declaration/Parser.php' === $rust_gateway_request_path
