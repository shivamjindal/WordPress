...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/src/HTTP/Psr18Client.php' );
if ( '/wp-includes/SimplePie/src/HTTP/Psr18Client.php' === $rust_gateway_request_path
