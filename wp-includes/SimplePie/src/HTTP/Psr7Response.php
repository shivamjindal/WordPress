...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/SimplePie/src/HTTP/Psr7Response.php' );
if ( '/wp-includes/SimplePie/src/HTTP/Psr7Response.php' === $rust_gateway_request_path
