...
if ( wp_rust_gateway_current_request_path( '/wp-includes/https-detection.php' ) === '/wp-includes/https-detection.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/https-detection.php' ) ) {
	exit;
}
