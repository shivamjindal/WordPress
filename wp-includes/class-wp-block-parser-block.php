...
if ( wp_rust_gateway_current_request_path( '/wp-includes/class-wp-block-parser-block.php' ) === '/wp-includes/class-wp-block-parser-block.php'
	&& wp_rust_gateway_try_proxy( '/wp-includes/class-wp-block-parser-block.php' ) ) {
	exit;
}
