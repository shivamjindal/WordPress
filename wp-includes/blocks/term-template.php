...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/term-template.php' );
if ( '/wp-includes/blocks/term-template.php' === $rust_gateway_request_path
