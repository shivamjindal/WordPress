...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/legacy-widget.php' );
if ( '/wp-includes/blocks/legacy-widget.php' === $rust_gateway_request_path
