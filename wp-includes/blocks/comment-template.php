...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/comment-template.php' );
if ( '/wp-includes/blocks/comment-template.php' === $rust_gateway_request_path
