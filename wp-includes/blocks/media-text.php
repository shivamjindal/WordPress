...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/media-text.php' );
if ( '/wp-includes/blocks/media-text.php' === $rust_gateway_request_path
