...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/accordion.php' );
if ( '/wp-includes/blocks/accordion.php' === $rust_gateway_request_path
