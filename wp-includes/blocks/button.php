...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/button.php' );
if ( '/wp-includes/blocks/button.php' === $rust_gateway_request_path
