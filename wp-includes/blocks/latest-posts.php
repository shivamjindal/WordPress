...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/latest-posts.php' );
if ( '/wp-includes/blocks/latest-posts.php' === $rust_gateway_request_path
