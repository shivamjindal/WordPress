...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/site-tagline.php' );
if ( '/wp-includes/blocks/site-tagline.php' === $rust_gateway_request_path
