...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/read-more.php' );
if ( '/wp-includes/blocks/read-more.php' === $rust_gateway_request_path
