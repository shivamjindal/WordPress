...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/query-total.php' );
if ( '/wp-includes/blocks/query-total.php' === $rust_gateway_request_path
