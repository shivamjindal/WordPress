...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/comment-date.php' );
if ( '/wp-includes/blocks/comment-date.php' === $rust_gateway_request_path
