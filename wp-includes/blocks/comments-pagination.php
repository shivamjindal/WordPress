...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/comments-pagination.php' );
if ( '/wp-includes/blocks/comments-pagination.php' === $rust_gateway_request_path
