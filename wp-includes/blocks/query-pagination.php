...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/query-pagination.php' );
if ( '/wp-includes/blocks/query-pagination.php' === $rust_gateway_request_path
