...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/post-comments-link.php' );
if ( '/wp-includes/blocks/post-comments-link.php' === $rust_gateway_request_path
