...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/pattern.php' );
if ( '/wp-includes/blocks/pattern.php' === $rust_gateway_request_path
