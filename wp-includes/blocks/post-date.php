...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/post-date.php' );
if ( '/wp-includes/blocks/post-date.php' === $rust_gateway_request_path
