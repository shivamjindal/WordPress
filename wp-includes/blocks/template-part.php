...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/template-part.php' );
if ( '/wp-includes/blocks/template-part.php' === $rust_gateway_request_path
