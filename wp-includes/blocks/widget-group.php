...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/widget-group.php' );
if ( '/wp-includes/blocks/widget-group.php' === $rust_gateway_request_path
