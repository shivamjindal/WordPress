...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/archives.php' );
if ( '/wp-includes/blocks/archives.php' === $rust_gateway_request_path
