...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/gallery.php' );
if ( '/wp-includes/blocks/gallery.php' === $rust_gateway_request_path
