...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/comment-reply-link.php' );
if ( '/wp-includes/blocks/comment-reply-link.php' === $rust_gateway_request_path
