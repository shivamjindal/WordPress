...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/footnotes.php' );
if ( '/wp-includes/blocks/footnotes.php' === $rust_gateway_request_path
