...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/navigation-submenu.php' );
if ( '/wp-includes/blocks/navigation-submenu.php' === $rust_gateway_request_path
