...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/calendar.php' );
if ( '/wp-includes/blocks/calendar.php' === $rust_gateway_request_path
