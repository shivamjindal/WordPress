...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/search.php' );
if ( '/wp-includes/blocks/search.php' === $rust_gateway_request_path
