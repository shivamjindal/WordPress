...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/query-pagination-numbers.php' );
if ( '/wp-includes/blocks/query-pagination-numbers.php' === $rust_gateway_request_path
