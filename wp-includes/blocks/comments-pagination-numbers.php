...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/comments-pagination-numbers.php' );
if ( '/wp-includes/blocks/comments-pagination-numbers.php' === $rust_gateway_request_path
