...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/loginout.php' );
if ( '/wp-includes/blocks/loginout.php' === $rust_gateway_request_path
