...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/categories.php' );
if ( '/wp-includes/blocks/categories.php' === $rust_gateway_request_path
