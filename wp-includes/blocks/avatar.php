...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/avatar.php' );
if ( '/wp-includes/blocks/avatar.php' === $rust_gateway_request_path
