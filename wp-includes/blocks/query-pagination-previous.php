...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/query-pagination-previous.php' );
if ( '/wp-includes/blocks/query-pagination-previous.php' === $rust_gateway_request_path
