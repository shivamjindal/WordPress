...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/tag-cloud.php' );
if ( '/wp-includes/blocks/tag-cloud.php' === $rust_gateway_request_path
