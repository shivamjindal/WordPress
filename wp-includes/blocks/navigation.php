...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/blocks/navigation.php' );
if ( '/wp-includes/blocks/navigation.php' === $rust_gateway_request_path
