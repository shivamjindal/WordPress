...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-includes/ID3/module.tag.lyrics3.php' );
if ( '/wp-includes/ID3/module.tag.lyrics3.php' === $rust_gateway_request_path
