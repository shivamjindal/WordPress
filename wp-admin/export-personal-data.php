...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/export-personal-data.php' );
if ( '/wp-admin/export-personal-data.php' === $rust_gateway_request_path
