...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/widgets-form-blocks.php' );
if ( '/wp-admin/widgets-form-blocks.php' === $rust_gateway_request_path
