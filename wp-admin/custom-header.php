...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/custom-header.php' );
if ( '/wp-admin/custom-header.php' === $rust_gateway_request_path && wp_rust_gateway_try_proxy( $rust_gateway_request_path ) ) {
	exit;
}
