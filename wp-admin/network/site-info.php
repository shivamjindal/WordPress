...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/network/site-info.php' );
if ( '/wp-admin/network/site-info.php' === $rust_gateway_request_path
