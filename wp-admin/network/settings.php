...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/network/settings.php' );
if ( '/wp-admin/network/settings.php' === $rust_gateway_request_path
