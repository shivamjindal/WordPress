...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/network/site-themes.php' );
if ( '/wp-admin/network/site-themes.php' === $rust_gateway_request_path
