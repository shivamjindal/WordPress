...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/edit-form-comment.php' );
if ( '/wp-admin/edit-form-comment.php' === $rust_gateway_request_path && wp_rust_gateway_try_proxy( $rust_gateway_request_path ) ) {
	exit;
}
