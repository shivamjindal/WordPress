...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/update-core.php' );
if ( '/wp-admin/includes/update-core.php' === $rust_gateway_request_path
