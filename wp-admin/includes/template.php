...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/template.php' );
if ( '/wp-admin/includes/template.php' === $rust_gateway_request_path
