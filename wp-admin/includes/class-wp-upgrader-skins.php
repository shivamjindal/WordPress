...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-upgrader-skins.php' );
if ( '/wp-admin/includes/class-wp-upgrader-skins.php' === $rust_gateway_request_path
