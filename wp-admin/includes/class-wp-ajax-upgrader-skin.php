...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-ajax-upgrader-skin.php' );
if ( '/wp-admin/includes/class-wp-ajax-upgrader-skin.php' === $rust_gateway_request_path
