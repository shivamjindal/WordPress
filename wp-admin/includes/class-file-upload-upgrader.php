...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-file-upload-upgrader.php' );
if ( '/wp-admin/includes/class-file-upload-upgrader.php' === $rust_gateway_request_path
