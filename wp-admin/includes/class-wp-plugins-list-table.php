...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-plugins-list-table.php' );
if ( '/wp-admin/includes/class-wp-plugins-list-table.php' === $rust_gateway_request_path
