...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-site-health.php' );
if ( '/wp-admin/includes/class-wp-site-health.php' === $rust_gateway_request_path
