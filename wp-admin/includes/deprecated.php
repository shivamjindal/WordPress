...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/deprecated.php' );
if ( '/wp-admin/includes/deprecated.php' === $rust_gateway_request_path
