...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-ftp.php' );
if ( '/wp-admin/includes/class-ftp.php' === $rust_gateway_request_path
