...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-language-pack-upgrader-skin.php' );
if ( '/wp-admin/includes/class-language-pack-upgrader-skin.php' === $rust_gateway_request_path
