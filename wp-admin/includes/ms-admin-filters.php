...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/ms-admin-filters.php' );
if ( '/wp-admin/includes/ms-admin-filters.php' === $rust_gateway_request_path
