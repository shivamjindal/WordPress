...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-walker-nav-menu-edit.php' );
if ( '/wp-admin/includes/class-walker-nav-menu-edit.php' === $rust_gateway_request_path
