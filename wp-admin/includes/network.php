...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/network.php' );
if ( '/wp-admin/includes/network.php' === $rust_gateway_request_path
