...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/upgrade.php' );
if ( '/wp-admin/includes/upgrade.php' === $rust_gateway_request_path
