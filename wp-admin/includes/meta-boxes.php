...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/meta-boxes.php' );
if ( '/wp-admin/includes/meta-boxes.php' === $rust_gateway_request_path
