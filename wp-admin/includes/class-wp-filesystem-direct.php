...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-filesystem-direct.php' );
if ( '/wp-admin/includes/class-wp-filesystem-direct.php' === $rust_gateway_request_path
