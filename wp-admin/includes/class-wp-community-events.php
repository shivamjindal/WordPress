...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-community-events.php' );
if ( '/wp-admin/includes/class-wp-community-events.php' === $rust_gateway_request_path
