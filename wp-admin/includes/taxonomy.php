...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/taxonomy.php' );
if ( '/wp-admin/includes/taxonomy.php' === $rust_gateway_request_path
