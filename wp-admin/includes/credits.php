...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/credits.php' );
if ( '/wp-admin/includes/credits.php' === $rust_gateway_request_path
