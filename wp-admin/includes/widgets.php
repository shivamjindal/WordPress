...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/widgets.php' );
if ( '/wp-admin/includes/widgets.php' === $rust_gateway_request_path
