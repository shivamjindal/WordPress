...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-site-health-auto-updates.php' );
if ( '/wp-admin/includes/class-wp-site-health-auto-updates.php' === $rust_gateway_request_path
