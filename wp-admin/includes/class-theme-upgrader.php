...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-theme-upgrader.php' );
if ( '/wp-admin/includes/class-theme-upgrader.php' === $rust_gateway_request_path
