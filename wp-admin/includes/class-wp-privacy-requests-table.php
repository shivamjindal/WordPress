...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-wp-privacy-requests-table.php' );
if ( '/wp-admin/includes/class-wp-privacy-requests-table.php' === $rust_gateway_request_path
