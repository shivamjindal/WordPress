...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/translation-install.php' );
if ( '/wp-admin/includes/translation-install.php' === $rust_gateway_request_path
