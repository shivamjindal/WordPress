...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/dashboard.php' );
if ( '/wp-admin/includes/dashboard.php' === $rust_gateway_request_path
