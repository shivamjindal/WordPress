...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/class-ftp-pure.php' );
if ( '/wp-admin/includes/class-ftp-pure.php' === $rust_gateway_request_path
