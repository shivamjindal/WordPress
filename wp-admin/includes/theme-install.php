...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/theme-install.php' );
if ( '/wp-admin/includes/theme-install.php' === $rust_gateway_request_path
