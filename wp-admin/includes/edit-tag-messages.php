...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/includes/edit-tag-messages.php' );
if ( '/wp-admin/includes/edit-tag-messages.php' === $rust_gateway_request_path
