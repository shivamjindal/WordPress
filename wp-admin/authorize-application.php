...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/authorize-application.php' );
if ( '/wp-admin/authorize-application.php' === $rust_gateway_request_path
