...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/options-permalink.php' );
if ( '/wp-admin/options-permalink.php' === $rust_gateway_request_path
