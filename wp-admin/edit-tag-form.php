...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-admin/edit-tag-form.php' );
if ( '/wp-admin/edit-tag-form.php' === $rust_gateway_request_path && wp_rust_gateway_try_proxy( $rust_gateway_request_path ) ) {
	exit;
}
