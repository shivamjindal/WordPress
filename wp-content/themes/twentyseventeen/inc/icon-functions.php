...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-content/themes/twentyseventeen/inc/icon-functions.php' );
if ( '/wp-content/themes/twentyseventeen/inc/icon-functions.php' === $rust_gateway_request_path
