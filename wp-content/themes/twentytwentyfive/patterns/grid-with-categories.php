...
$rust_gateway_request_path = wp_rust_gateway_current_request_path( '/wp-content/themes/twentytwentyfive/patterns/grid-with-categories.php' );
if ( '/wp-content/themes/twentytwentyfive/patterns/grid-with-categories.php' === $rust_gateway_request_path
